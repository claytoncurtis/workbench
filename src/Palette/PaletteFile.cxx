...
PaletteFile::addDefaultPalettes()
{
    ...
    if (this->getPaletteByName("JET256") == NULL) {
        ...
        JET256.addScalarAndColor(1.0f, "_J0");
        JET256.addScalarAndColor(0.875f, "_J1");//also rounding to probably-intended control points
        JET256.addScalarAndColor(0.625f, "_J3");
        JET256.addScalarAndColor(0.375f, "_J5");
        JET256.addScalarAndColor(0.125f, "_J7");
        JET256.addScalarAndColor(0.0f, "_J8");
        addPalette(JET256);
    }

    if (this->getPaletteByName("JerdeD1") == NULL) {
        Palette JerdeD1;
        JerdeD1.setName("JerdeD1");
        
        this->addColor("_JD0", 0, 255, 255);
        this->addColor("_JD1", 0, 200, 0);
        this->addColor("_JD2", 255, 255, 0);
        this->addColor("_JD3", 255, 153, 0);
        this->addColor("_JD4", 255, 0, 0);
        this->addColor("_JD5", 255, 0, 255);
        this->addColor("_JD6", 122, 16, 228);
        this->addColor("_JD7", 0, 0, 255);
        
        JerdeD1.addScalarAndColor(1.0f, "_JD7");
        JerdeD1.addScalarAndColor(0.875f, "_JD6");
        JerdeD1.addScalarAndColor(0.750f, "_JD5");
        JerdeD1.addScalarAndColor(0.625f, "_JD4");
        JerdeD1.addScalarAndColor(0.5f, "_JD3");
        JerdeD1.addScalarAndColor(0.375f, "_JD2");
        JerdeD1.addScalarAndColor(0.250f, "_JD1");
        JerdeD1.addScalarAndColor(0.125f, "_JD0");
        JerdeD1.addScalarAndColor(0.0f, "none");
        
        addPalette(JerdeD1);
    }
    
        if (this->getPaletteByName("JerdeD2") == NULL) {
        Palette JerdeD2;
        JerdeD2.setName("JerdeD2");
        
        this->addColor("_JE0", 0, 255, 255);
        this->addColor("_JE1", 0, 255, 0);
        this->addColor("_JE2", 255, 255, 0);
        this->addColor("_JE3", 255, 153, 0);
        this->addColor("_JE4", 255, 0, 0);
        this->addColor("_JE5", 255, 0, 255);
        this->addColor("_JE6", 122, 16, 228);
        this->addColor("_JE7", 0, 0, 255);
        
        JerdeD2.addScalarAndColor(1.0f, "_JE1");
        JerdeD2.addScalarAndColor(0.875f, "_JE0");
        JerdeD2.addScalarAndColor(0.750f, "_JE7");
        JerdeD2.addScalarAndColor(0.625f, "_JE6");
        JerdeD2.addScalarAndColor(0.5f, "_JE5");
        JerdeD2.addScalarAndColor(0.375f, "_JE4");
        JerdeD2.addScalarAndColor(0.250f, "_JE3");
        JerdeD2.addScalarAndColor(0.125f, "_JE2");
        JerdeD2.addScalarAndColor(0.0f, "none");
        
        //JerdeD2.addScalarAndColor(1.0f, "_JE5");
        //JerdeD2.addScalarAndColor(0.750f, "_JE4");
        //JerdeD2.addScalarAndColor(0.5f, "_JE3");
        //JerdeD2.addScalarAndColor(0.250f, "_JE2");
        //JerdeD2.addScalarAndColor(0.0f, "none");
